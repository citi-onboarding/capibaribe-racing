...
function AboutInfo() {
  ...
  return (
    <section className={styles.BackgroundSection} style={{ backgroundImage: `url(${menu ? (aboutcar.map((d) => d.image.secure_url)) : (formulasae.map((d) => d.image.secure_url)) })` }}>
      <div className="container" id={styles.aboutInfo}>
