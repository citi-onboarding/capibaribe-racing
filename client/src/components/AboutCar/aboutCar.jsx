...
function AboutCar() {
  ...
  return (
    <section className={styles.aboutCar} id="container">
        ...
        { menu ?
        (<div className={styles.gridSectionAboutCarContent} id="aboutcar">
            <div></div>
        ...
        (<div className={styles.gridSectionAboutCarContent} id="aboutsae">
            <div></div>
            <div className={styles.articleAboutCar}>
